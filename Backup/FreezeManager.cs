...
public class FreezeManager : MonoBehaviour
{
  ...
  private void Start() => this.itemsFolder = ((Component) this).gameObject;
    ...
    if (Object.op_Inequality((Object) this.Cursor, (Object) null))
    {
      ...
      if (this.primaryDown)
      {
        if (this.canPlace & flag)
        {
          ...
          attachedRigidbody.constraints = attachedRigidbody.constraints == null ? (RigidbodyConstraints) 126 : (RigidbodyConstraints) 0;
